...
namespace QOS.Areas.Report.Controllers
{
    ...
    [Area("Report")]
    public class SummaryCheckerController : Controller
    {
        private readonly ILogger<SummaryCheckerController> _logger;
        ...
        {
            // return View();
            return RedirectToAction("SummaryChecker", "SummaryChecker");
        }
        [TempData]
        public string? MessageStatus { get; set;}
        [HttpGet]
        public IActionResult SummaryChecker(string? topDefected, string? typeCode, string? Unit, string? Line, string? Mo, string? styleCode, DateTime? dateFrom, DateTime? dateEnd)
        {
            _logger.LogInformation("=== SummaryChecker GET Request ===");
            ...
            {
                _logger.LogError(ex, "Error in SummaryChecker GET");
        ...
        private void LoadReportData(SummaryKCCViewModel model)
        {
            try
            {
                ...
                var sql = @"EXEC RP_TonghoploiChecker84_KHachHang_MO @Date_From, @Date_To, @Unit, @Line, @MO, @StyleCode, @Defected_Type, @Top_Defected, @Search";
        ...
        public IActionResult ExportToExcel( string? topDefected, string? typeCode, string? Unit, string? Line, string? Mo, string? styleCode, DateTime? dateFrom, DateTime? dateEnd, string faultCodes)
        {
            ...
            using var cmd = new SqlCommand("RP_TonghoploiChecker84_KHachHang_DownloadExcelDetail_Mo", conn);
