    ...
    public class EndlineUnitController : Controller
    {
        ...
        private void LoadReportDataSewer(EndlineUnitViewModel model)
        {
            ...
            try
            {
                ...
                using (var command = new SqlCommand("RP_BaoCaoChatLuongChecker_KCC_Unit", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@Date_F", dateFStr);
                    command.Parameters.AddWithValue("@Date_T", dateTStr);
        ...
        private void LoadReportDataSewerDetail(EndlineUnitViewModel model)
        {
            ...
            try
            {
                ...
                using (var command = new SqlCommand("RP_BaoCaoChatLuongChecker_KCC_Sewer_Date", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@Date_F", dateFStr);
                    command.Parameters.AddWithValue("@Date_T", dateTStr);
        ...
        private void LoadReportDataSewerDetailImg(EndlineUnitViewModel model)
        {
            ...
            try
            {
                ...
                using (var command = new SqlCommand("RP_BaoCaoChatLuongChecker_KCC_Sewer_IMG", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@Date_F", dateFStr);
                    command.Parameters.AddWithValue("@Date_T", dateTStr);
