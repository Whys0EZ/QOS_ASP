...
namespace QOS.Areas.Report.Controllers
{
    [Authorize]
    [Area("Report")]
    public class Form10OQLController : Controller
    {
        private readonly ILogger<Form10OQLController> _logger;
        ...
        {
            return RedirectToAction("RP_Form10OQL");
        }
        
        public ActionResult RP_Form10OQL(string unit = "1U01", int month = 0, int year = 0)
            {
        ...
        public List<OQL_EndLine> GetOQLData(string unit, int month, int year)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                //     FROM [QOS].[dbo].[OQL_EndLine_Checker84]
                //     WHERE [Unit] = @Unit 
