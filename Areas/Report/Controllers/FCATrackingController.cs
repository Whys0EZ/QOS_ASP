...
namespace QOS.Areas.Report.Controllers
{
    [Authorize]
    [Area("Report")]
    public class FCATrackingController : Controller
    {

        private readonly ILogger<FCATrackingController> _logger;
        private readonly IWebHostEnvironment _env;
        private readonly IConfiguration _configuration;
        private readonly AppDbContext _context;

        public FCATrackingController(ILogger<FCATrackingController> logger, IWebHostEnvironment env, IConfiguration configuration, AppDbContext context)
        {
            _logger = logger;
            _env = env;
        ...
        {
            return RedirectToAction("FCATracking", "FCATracking");
        }
        public IActionResult FCATracking(string? Industry, string? Customer,string? Operation, DateTime? dateFrom, DateTime? dateEnd, string? Search)
        {
                ...
                using (var connection = new SqlConnection(_context.Database.GetConnectionString()))
                    {
                        ...
                        var sql = @"EXEC TRACKING_Select_data_to_Report @Customer,@Seach, @Date_F, @Date_T";
