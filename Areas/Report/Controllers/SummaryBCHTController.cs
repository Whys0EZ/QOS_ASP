...
namespace QOS.Areas.Report.Controllers
{
    ...
    [Area("Report")]
    public class SummaryBCHTController : Controller
    {
        private readonly ILogger<SummaryBCHTController> _logger;
        ...
        {
            // return View();
            return RedirectToAction("SummaryBCHT", "SummaryBCHT");
        }
        [TempData]
        ...
        public IActionResult SummaryBCHT(string? topDefected, string? typeCode, string? Unit, string? Line, string? Mo, string? styleCode, DateTime? dateFrom, DateTime? dateEnd)
        {
            ...
            {
                _logger.LogError(ex, "Error in SummaryBCHT GET");
        ...
        public IActionResult ExportToExcel( string? topDefected, string? typeCode, string? Unit, string? Line, string? Mo, string? styleCode, DateTime? dateFrom, DateTime? dateEnd, string faultCodes)
        {
            ...
            {
                _logger.LogInformation("Không có dữ liệu để xuất báo cáo, quay về trang SummaryBCHT.");
                MessageStatus = "Không có dữ liệu để xuất báo cáo.";
                return RedirectToAction("SummaryBCHT");
            }
            ...
            using var cmd = new SqlCommand("RP_TonghoploiChecker84_DownloadExcelDetail_MO", conn);
            ...
            return File(stream.ToArray(),
                ...
                $"Report_HoanThien_{DateTime.Now:yyyyMMddHHmmss}.xlsx");
        }
