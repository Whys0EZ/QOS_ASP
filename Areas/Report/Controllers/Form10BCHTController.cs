...
namespace QOS.Areas.Report.Controllers
{
    ...
    [Area("Report")]
    public class Form10BCHTController : Controller
    {
        private readonly ILogger<Form10BCHTController> _logger;
        ...
        {
            // return View();
            return RedirectToAction("RP_Form10", "Form10BCHT");
        }
        [TempData]
        ...
        public IActionResult RP_Form10(string? Unit, DateTime? dateFrom, DateTime? dateEnd)
        {
            ...
            {
                _logger.LogError(ex, "Error in RP_Form10 GET");
        ...
        private void LoadReportData(RP_Form6ViewModel model)
        {
            ...
            using var cmd = new SqlCommand("Form10_BCHT_SUM_Report", conn);
        ...
        private List<LineHistoryDataForm6> GetLineHistoryData(string lineCode, DateTime dateFrom, DateTime dateEnd)
        {
            ...
            try
            {
                ...
                var query = @"
                    ...
                    FROM Form10_BCHT t1 LEFT JOIN User_List t4 ON t1.UserUpdate=t4.UserName 
        ...
        public IActionResult DetailForm10(int id)
        {
            using var conn = new SqlConnection(_configuration.GetConnectionString("DefaultConnection"));
            string sql = @"
        ...
        public IActionResult DeleteReport(int reportId)
        {
            ...
            using var conn = new SqlConnection(_configuration.GetConnectionString("DefaultConnection"));
            using var command = new SqlCommand("Delet_BC_Form10_BCHT", conn);
        ...
        public IActionResult ExportExcel ( string? Unit, DateTime? dateFrom, DateTime? dateEnd)
        {
            ...
            if (!System.IO.File.Exists(templatePath))
            {
                ...
                return RedirectToAction("RP_Form10");
            }
