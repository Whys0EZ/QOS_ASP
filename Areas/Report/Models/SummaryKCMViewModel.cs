...
{
    public class SummaryKCMViewModel
    {
        ...
        public Dictionary<string, DefectStatKCM> DefectStatKCMs { get; set; } = new Dictionary<string, DefectStatKCM>();
        public int TotalDefects { get; set; }
        public List<string> Zone { get; set; } = new List<string>();
        public List<string> Block {get; set; } = new List<string>();
    }

    public class DefectStatKCM
    {
