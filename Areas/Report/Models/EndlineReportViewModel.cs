...
{
    public class EndlineReportViewModel
    {
        ...
        public Dictionary<string, DefectCode_EndlineReport> DefectCodes { get; set; } = new Dictionary<string, DefectCode_EndlineReport>();
    }
    public class DefectCode_EndlineReport
    {
