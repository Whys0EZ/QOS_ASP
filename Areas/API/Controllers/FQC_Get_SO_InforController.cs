...
namespace QOS.Areas.API.Controllers
{
    ...
    [ApiController]
    public class FQC_Get_SO_InforController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly string _connectionString;
        private readonly ILogger<FQC_Get_SO_InforController> _logger;

        public FQC_Get_SO_InforController(IConfiguration config, ILogger<FQC_Get_SO_InforController> logger)
        {
            _config = config;
            _logger = logger;
        ...
        [HttpGet]
        [HttpGet("[action]")]
        public IActionResult FQC_Get_SO_Infor(string? Code_G)
        {
            ...
            try
            {
                ...
                response = new
                {
                    ETS_Data_MO_Info = ETS_Data_MO_Info(firstValue)
                };
        ...
        private List<object> ETS_Data_MO_Info(string firstValue)
        {
