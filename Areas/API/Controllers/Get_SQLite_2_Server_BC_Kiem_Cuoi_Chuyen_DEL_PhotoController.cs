...
namespace QOS.Areas.API.Controllers
{
    ...
    [ApiController]
    public class Get_SQLite_2_Server_BC_Kiem_Cuoi_Chuyen_DEL_PhotoController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly IWebHostEnvironment _environment;
        private readonly ILogger<Get_SQLite_2_Server_BC_Kiem_Cuoi_Chuyen_DEL_PhotoController> _logger;
