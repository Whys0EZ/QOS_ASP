...
namespace QOS.Areas.API.Controllers
{
    ...
    public class Get_SO_Infor_From_FQCController : ControllerBase
    {
        ...
        public Get_SO_Infor_From_FQCController(
            IConfiguration config,
            ILogger<Get_SO_Infor_From_FQCController> logger
        )
        {
            _config = config;
            _logger = logger;
        ...
        public IActionResult Get_SO_Infor_From_FQC(string? Code_G)
        {
            ...
            try
            {
                ...
                {
                    response = new { Data_SO_Info = Data_SO_Info(MO) };
                }
                else
                {
                    response = new { Data_SO_Info = new List<object>() };
                }
