...
namespace QOS.Areas.API.Controllers
{
    ...
    [ApiController]
    public class Get_SQLite_2_Server_BC_Checker84_Upload_IMGController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly IWebHostEnvironment _environment;
        private readonly ILogger<Get_SQLite_2_Server_BC_Checker84_Upload_IMGController> _logger;

        public Get_SQLite_2_Server_BC_Checker84_Upload_IMGController(
            IConfiguration config,
            IWebHostEnvironment environment,
            ILogger<Get_SQLite_2_Server_BC_Checker84_Upload_IMGController> logger)
        {
            _config = config;
        ...
        [HttpPost]
        public IActionResult Get_SQLite_2_Server_BC_Checker84_Upload_IMG(
            ...
            [FromForm] PhotoUploadRequest request)
        {
            ...
            try
            {
                ...
                // ✅ XỬ LÝ UPLOAD
                string formID = "Form10_BCHT";
                string imagePath = Path.Combine(_environment.WebRootPath, "upload", "Photos", "Form10_BCHT");
                string textCut = "_###_";
