...
namespace QOS.Areas.API.Controllers
{
    ...
    [ApiController]
    public class feature_frm_ThongSo_BTP_SearchController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly string _connectionString;
        private readonly ILogger<feature_frm_ThongSo_BTP_SearchController> _logger;

        public feature_frm_ThongSo_BTP_SearchController(IConfiguration config, ILogger<feature_frm_ThongSo_BTP_SearchController> logger)
        {
            _config = config;
            _logger = logger;
        ...
        [HttpGet]
        public IActionResult feature_frm_ThongSo_BTP_Search(
            string? Code_G, 
            string? Search_txt, 
            string? Unit)
        {
            ...
            try
            {
                ...
                // Query database...
                var ThongSoBTPList = GetThongSoBTPData(factoryID, dateF, Unit ?? "", Search_txt ?? "");

                return Ok(new { ThongSo_BTP_Search = ThongSoBTPList });
            }
        ...
        private List<object> GetThongSoBTPData(string factoryID, string dateF, string unit, string searchTxt)
        {
...
// GET api/feature_frm_ThongSo_BTP_Search?Code_G=f4cf3fe4b67244332eecec055742d449REG263ca1464c3480896c1b78a5eac5a6e971f0e3dad99908345f7439f8ffabdffc4_____DeviceName_____MAC_____LoginID_____2025-10-28&Search_txt=&Unit=2U01&Line=201S01&ALL=YES