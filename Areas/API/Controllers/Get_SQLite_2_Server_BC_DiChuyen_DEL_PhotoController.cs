...
namespace QOS.Areas.API.Controllers
{
    ...
    [ApiController]
    public class Get_SQLite_2_Server_BC_DiChuyen_DEL_PhotoController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly IWebHostEnvironment _environment;
        private readonly ILogger<Get_SQLite_2_Server_BC_DiChuyen_DEL_PhotoController> _logger;

        public Get_SQLite_2_Server_BC_DiChuyen_DEL_PhotoController(
            IConfiguration config,
            IWebHostEnvironment environment,
            ILogger<Get_SQLite_2_Server_BC_DiChuyen_DEL_PhotoController> logger)
        {
            _config = config;
        ...
        public IActionResult Get_SQLite_2_Server_BC_DiChuyen_DEL_Photo(
