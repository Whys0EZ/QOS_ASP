            ...
            using (SqlCommand cmd = new("Json_RP_BCDT_SUM", conn))
            {
                ...
                while (dr.Read())
                {
                    list.Add(new BCDTModel
                    {
                        ...
                        vai_ke = Functions.GetIntValue(dr, "vai_ke"),
                        noi_vai = Functions.GetIntValue(dr, "noi_vai"),
                        cang_vai = Functions.GetIntValue(dr, "cang_vai"),
                        sai_mat = Functions.GetIntValue(dr, "sai_mat"),
                        hep_kho = Functions.GetIntValue(dr, "hep_kho"),
                        ban_vai = Functions.GetIntValue(dr, "ban_vai"),
                        vi_tri = Functions.GetIntValue(dr, "vi_tri"),
                        vai_nghieng = Functions.GetIntValue(dr, "vai_nghieng"),
                        song_vai = Functions.GetIntValue(dr, "song_vai"),
                        thang_ke = Functions.GetIntValue(dr, "thang_ke"),
                        khac_mau = Functions.GetIntValue(dr, "khac_mau"),
                        quen_bam = Functions.GetIntValue(dr, "quen_bam"),
                        bam_sau = Functions.GetIntValue(dr, "bam_sau"),
                        xoc_xech = Functions.GetIntValue(dr, "xoc_xech"),
                        khong_cat = Functions.GetIntValue(dr, "khong_cat"),
                        khong_gon = Functions.GetIntValue(dr, "khong_gon"),
                        doi_ke = Functions.GetIntValue(dr, "doi_ke"),
                        doi_xung = Functions.GetIntValue(dr, "doi_xung"),
                        so_lop = Functions.GetIntValue(dr, "so_lop"),
                        so_btp = Functions.GetIntValue(dr, "so_btp"),
