...
namespace QOS.Areas.API.Controllers
{
    ...
    [ApiController]
    public class Get_SQLite_2_Server_BC_Kiem_Cuoi_Chuyen_DELController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Get_SQLite_2_Server_BC_Kiem_Cuoi_Chuyen_DEL(
        ...
        private string DeleteImageList( string? Img_Name )
        {
            ...
            {
                _logger?.LogWarning("DeleteImageList called with null or empty Img_Name.");
