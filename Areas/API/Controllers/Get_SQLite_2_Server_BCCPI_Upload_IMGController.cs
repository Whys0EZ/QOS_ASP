...
namespace QOS.Areas.API.Controllers
{
    ...
    [ApiController]
    public class Get_SQLite_2_Server_BCCPI_Upload_IMGController : ControllerBase
    {
        private readonly IConfiguration _config;
        private readonly IWebHostEnvironment _environment;
        private readonly ILogger<Get_SQLite_2_Server_BCCPI_Upload_IMGController> _logger;

        public Get_SQLite_2_Server_BCCPI_Upload_IMGController(
            IConfiguration config,
            IWebHostEnvironment environment,
            ILogger<Get_SQLite_2_Server_BCCPI_Upload_IMGController> logger)
        {
            _config = config;
            ...
            [FromBody] PhotoUploadRequest request)
        {
            ...
            try
            {
                ...
                string imagePath = Path.Combine(_environment.WebRootPath, "upload", "Photos", "Form2_CPI");
                string textCut = "_###_";
